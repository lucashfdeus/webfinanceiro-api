...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
		...
		// esse primeiro if seria a condição com o where descricao like 'alguma coisa';
		// usaremos o METAMODEL no lugar da String para evitar o erro de digitação no
		// campo root.get("descricao") inserindo a dependência no POM
